...
function register() {
  ...
  var url = "https://35zgle2eic.execute-api.us-east-1.amazonaws.com/NovoEstagio";
  xhttp.open("POST", url);
...
function getUser(){
  ...
  var url = "https://35zgle2eic.execute-api.us-east-1.amazonaws.com/NovoEstagio?from=" + user;
